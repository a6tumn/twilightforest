	...
	public class ForceFieldElementBuilder {
		...
		public class FaceBuilder {
			...
			public ForceFieldElementBuilder.FaceBuilder uvs(float u1, float v1, float u2, float v2) {
				Preconditions.checkNotNull(texture, "UVs must not be null");
			...
			CuboidFace build() {
				...
				return new CuboidFace(this.cullface, this.tintindex, this.texture, this.uvs, Quadrant.parseJson(this.rotation.rotation), ExtraFaceData.DEFAULT, new MutableObject<>());
			}
