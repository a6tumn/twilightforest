...
public class BlockModelGenerator extends BlockModelBuilders {
	...
	private void generateWoodBlocks() {
		...
		this.generateJarLidModel(Items.ACACIA_LOG);
		this.generateJarLidModel(Items.BIRCH_LOG);
		this.generateJarLidModel(Items.CHERRY_LOG);
		this.generateJarLidModel(Items.DARK_OAK_LOG);
		this.generateJarLidModel(Items.JUNGLE_LOG);
		this.generateJarLidModel(Items.MANGROVE_LOG);
		this.generateJarLidModel(Items.OAK_LOG);
		...
		this.generateJarLidModel(Items.STRIPPED_DARK_OAK_LOG);
		this.generateJarLidModel(Items.STRIPPED_JUNGLE_LOG);
		this.generateJarLidModel(Items.STRIPPED_MANGROVE_LOG);
		this.generateJarLidModel(Items.STRIPPED_OAK_LOG);
		...
		this.generateJarLidModel(TFBlocks.MANGROVE_LOG.asItem());
		this.generateJarLidModel(TFBlocks.CANOPY_LOG.asItem());
		this.generateJarLidModel(TFBlocks.DARK_LOG.asItem());
		this.generateJarLidModel(TFBlocks.MINING_LOG.asItem());
		this.generateJarLidModel(TFBlocks.SORTING_LOG.asItem());
		this.generateJarLidModel(TFBlocks.TIME_LOG.asItem());
		this.generateJarLidModel(TFBlocks.TRANSFORMATION_LOG.asItem());
		this.generateJarLidModel(TFBlocks.TWILIGHT_OAK_LOG.asItem());
		this.generateJarLidModel(TFBlocks.CINDER_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_MANGROVE_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_CANOPY_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_DARK_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_MINING_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_SORTING_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_TIME_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_TRANSFORMATION_LOG.asItem());
		this.generateJarLidModel(TFBlocks.STRIPPED_TWILIGHT_OAK_LOG.asItem());
	}
}
